...
public class StartScreen2 implements Screen {
    ...
    public void render(float delta) {
        ...
        Texture lvl1Tex = MyGdxGame.manager.get("img/stage2.png", Texture.class);
        lvl2Img = new Image(lvl1Tex);
        lvl2Img.setPosition(stage.getWidth() / 2 - lvl2Img.getWidth() / 10, stage.getHeight()  - lvl2Img.getHeight() / 3);
        lvl2Img.addAction(scaleTo(.2f, .2f));
